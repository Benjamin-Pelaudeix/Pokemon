...
public class Nourriture extends Item implements Utilisable {
	...
	public static String[] tousLesTypesDePokemons = {"PLANTE", "POISON", "FEU", "DRAGON", "VOL", "EAU", 
											"INSECTE", "NORMAL", "FONCE", "ELECTRIQUE", "TELEPATIQUE", 
												"GLACE", "ACIER", "TERRE", "FEE", "COMBAT", "ROCHE", "FANTOME"};
	...
	public boolean isCompatible(Pokemon pokemon) {
		...
		if (null != pokemon && !trouve) {
			System.out.println("Un pokemon de type " + pokemon.getType() + " n'est pas compatible avec "
					+ "une nourriture de type " + this.getNom() + ".");
		}
		return trouve;
	}
